...
class App extends React.Component {
  ...
  renderTable() {
    return (
      <table >
        <thead  className='table100-body js-pscroll'>
        ...
        <tr key={btoa('row'+rows.length)}
         >
          {this.state.selectedColumns.map(col =>
            <td key={col} 
                 style={{border: '1px solid grey', borderCollapse: 'collapse', padding: '5px'}}
  ...
  render() {    
    return (
      <div>
        ...
        <br/>
        <label style={{fontSize: '1em', color: '#2b0ece', marginBottom: '1'}}><strong>Select a Table</strong></label>
        <br/>
        <select style={{
                  width: '12%',
                  padding :' 12px 20px',
                  ...
                  border: '1px solid #092ed1',
                  borderradius: '4px',
                  boxsizing: 'border-box',
                  fontSize: '1em', color: '#177CB8'
              }} 
        ...
        <br/>
        <label
        style={{fontSize: '1em', color: '#2b0ece', marginBottom: '1'}}>
          
         <strong> Select {this.state.selectedTable} Columns </strong>
        ...
        <select style={{
                  ...
                  margin: '8px 0',
                  display: 'inline-block',
                  border: '1px solid #3c7fd8',
                  borderradius: '4px',
                  boxsizing: 'border-box',
                  fontSize: '1em', color: '#177CB8'
              }} 
                onChange={this.onColumnChange} multiple>
          { this.renderColumnList() }
        </select>
        <br/>
        <br/>
        { this.state.selectedColumns.length > 0 ? <button 
                    style={{
                      background: '#ccc',
                      width: '20%',
                      padding :' 12px 20px',
                      margin: '8px 0',
                      display: 'inline-block',
                      border: '1.5px solid #3c7fd8',
                      borderradius: '4px',
                      boxsizing: 'border-box',
                      fontSize: '1em', color: '#092ed1'
                  }} 
        
                  onClick={this.getData}><strong>Get { this.state.selectedTable } Data</strong></button> : null }
        <br/>
        <br/>
